  ...
  <div class="table">
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="select_word" size="mini" placeholder="筛选用户名"
...
import {getUserOfId, getAllComment, deleteComment} from '../api/index'
...
export default {
  ...
  methods: {
    ...
    getData () {
      this.tempData = []
      this.tableData = []
      getAllComment(this.$route.query.id,this.$route.query.type).then(res => {
        for (let item of res) {
